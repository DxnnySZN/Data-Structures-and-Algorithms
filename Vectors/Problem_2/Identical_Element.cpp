...
int main() {
    ...
    for(int i = 0; i < numsSize; ++i){
        cin >> nums[i];
        countMap[nums[i]]++; /* Iteration 1 (i = 0, nums[0] = 3):
    ...
    cout << mostRepeatedValue << " has " << highestCount << " identical elements in nums" << endl;
    return 0;

    /* Test_Case: 8
                  3 5 9 7 6 7 4 0
                  
       Output:    7 has 2 identical elements in nums */
}